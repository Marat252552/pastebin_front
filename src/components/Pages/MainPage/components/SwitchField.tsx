...
const SwitchField = ({register, setOne_read, disabled}: {setOne_read: React.Dispatch<React.SetStateAction<boolean>>, register: UseFormRegister<Inputs_T>, disabled: boolean}) => {
